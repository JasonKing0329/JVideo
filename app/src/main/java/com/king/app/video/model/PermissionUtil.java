...
public class PermissionUtil {
    ...
    public static void requestOtherPermission(Activity activity) {
        ...
        status = ContextCompat.checkSelfPermission(activity, "mobile.androidpermission.regioncontentprovider.READ_REGION");
        if (status != PackageManager.PERMISSION_GRANTED) {
            ActivityCompat.requestPermissions(activity, new String[]{"mobile.androidpermission.regioncontentprovider.READ_REGION"}, 0);
        }
    }
